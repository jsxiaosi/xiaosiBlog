...
export default (app: Application) => {
  ...
  router.get('/api/blog/article_info', controller.article.home.blogGetArticleInfo);
  ...
  router.post('/api/article/update_top', adminauth, controller.article.home.updateIsTop);
