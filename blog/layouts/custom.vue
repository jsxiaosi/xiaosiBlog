...
<template>
  <div class="main">
    <a href="https://github.com/jsxiaosi" class="github-corner" aria-label="View source on GitHub"><svg
      width="80" height="80"
      viewBox="0 0 250 250"
      style="color:currentColor; position: absolute; z-index: 0; top: 55px; border: 0; right: 0;"
      aria-hidden="true"
    >
